...
<div class="list-group list-custom-small list-menu">
    ...
    <a id="nav-pages" href="index-pages.html" class="active-nav">
...
<h6 class="menu-divider font-10 mt-4">Made with <i class="fa fa-heart color-red-dark pl-1 pr-1"></i> by Enabled in
    <span class="copyright-year">2021</span></h6>
