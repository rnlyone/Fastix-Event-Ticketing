...
Route::group(['middleware'=>['auth']], function(){
    Route::middleware(['role:cust'])->group(function () {
        ...
        Route::get('order/finresponse/{id}', [OrderController::class, 'finishedpayment'])->name('order.finish');
        Route::get('order/unfinresponse/{id}', [OrderController::class, 'unfinishedpayment'])->name('order.unfinish');
